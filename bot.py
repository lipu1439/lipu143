...
async def like_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    loading_msg = await update.message.reply_text("⏳ Generating your link, please wait...")
    ...
    # 🧹 Edit loading message with final content and buttons
    await loading_msg.edit_text(msg, reply_markup=keyboard, parse_mode='Markdown')
